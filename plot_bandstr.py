...
def plot_band():
    ...
    file_op = st.sidebar.radio("Here is the band structure of primitive diamond, upload others by youself", ["primitive diamond cell", "upload a .dat file")
    data =""
    if file_op == "primitive diamond cell":
        with open("example_diamod2/", "r") as f:
            data = f.readlines()
    else:
